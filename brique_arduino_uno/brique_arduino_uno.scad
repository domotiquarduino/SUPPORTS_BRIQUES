use <C:\Users\"VOTRE NOM UTILSATEUR"\Desktop\pieces_3D_openscad\brique_ajustable\bloc_brique.scad>
use <C:\Users\"VOTRE NOM UTILSATEUR"\Desktop\pieces_3D_openscad\PIECES_ELECTRONIQUES\uno\carte_uno.scad>
use <C:\Users\"VOTRE NOM UTILSATEUR"\Desktop\pieces_3D_openscad\PIECES_ELECTRONIQUES\visserie\M2.scad>
use <C:\Users\"VOTRE NOM UTILSATEUR"\Desktop\pieces_3D_openscad\PIECES_ELECTRONIQUES\pile\pile_9v.scad>
...
afficher_support_pile ="n"; // "o" ou "n"
...
afficher_fixation     ="n"; // "o","n"
afficher_arduino_uno  ="o"; // "o","n"
afficher_M2_femelle   ="n"; // "o","n"
afficher_M2_male      ="n"; // "o","n"
afficher_pile         ="n"; // "o","n"
...
if(afficher_arduino_uno=="o") translate([0,0.5,21.25]) rotate([0,0,180])  arduino_uno();
if(afficher_M2_femelle=="o")
{
translate ([24,19,13.02]) M2_femelle_male();
translate ([-24,20.5,13.02]) M2_femelle_male();
translate ([-19,-31.5,13.02]) M2_femelle_male();
translate ([8.5,-31.5,13.02]) M2_femelle_male();
}
if(afficher_M2_male=="o")
{
translate ([24,19,23.1]) M2_male();
translate ([-24,20.5,23.1]) M2_male();
translate ([-19,-31.5,23.1]) M2_male();
translate ([8.5,-31.5,23.1]) M2_male();
}
...
{  
 ...
 if(afficher_pile=="o") translate([0,0,3.05]) rotate([0,0,90]) pile_9V();
...
module socle()
{
       ...
       difference()
       {
              union()
              {
          translate([0.00,0.00,3.00/2]) roundedBox([57.00,75.00,3.00],5.00,true);                      
...
{
  if(y==79.82 && x==63.82) bloc10x7();              
}

module bloc10x7()
{
  bloc(10,8,hauteur_brique/3,axe_trou=false,trou_circulaire=false,renforcement=true,goujon_creux=false,surface_plate=false);     
}
...
module bloc2x2()
{
  bloc(2,2,hauteur_brique/3,axe_trou=false,trou_circulaire=false,renforcement=true,goujon_creux=false,surface_plate=false);     
}
